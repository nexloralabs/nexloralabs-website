...
export default function Hero() {
    ...
    return (
        <section className="relative flex items-center justify-center overflow-hidden bg-[#FAFAF8] pt-28 pb-14 md:pt-28 md:pb-16 lg:pt-28 lg:pb-16 font-dm">
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-16 grid lg:grid-cols-[1fr_auto] gap-10 items-center">
                ...
                <div className="flex flex-col relative">
                    ...
                    {/* ── CTAs & Bottom Content Wrapper ── */}
                    <div className="flex flex-row items-start gap-8">
                        
                        {/* Grouped Left Side: Buttons + Social Proof */}
                        <div className="flex flex-col gap-5 sm:gap-6">
                            
                            {/* ── CTAs ── */}
                            <div
                                className="hero-fade-in flex flex-col sm:flex-row items-start sm:items-center gap-4"
                        ...
                        <m.div
                            ...
                            className="hidden xl:block max-w-[220px] -rotate-[2deg] hover:rotate-0 transition-transform duration-300 mt-2 xl:ml-2"
                        >
